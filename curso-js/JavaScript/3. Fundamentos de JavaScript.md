...
- [ ] Ejecutar un fichero js en navegador, quoakka.js y terminal #fundamentosjs ✅ 2025-01-14
...
Posible solución:
```js
const measureKelvin = function () {    const measurement = {  
        type: 'temp',  
        unit: 'celsius',  
        value:  prompt('Introduce los grados Celsius')  
    };  
...
console.log('voy a ejutar la función measureKelvin');  
const gradosKelvin = measureKelvin();  
console.log(`Los grados en Kelvin son: ${gradosKelvin}`);  
console.log('ya he ejecutado la función measureKelvin');
```