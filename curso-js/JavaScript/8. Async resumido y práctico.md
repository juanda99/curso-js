...
- Si los datos no existen, porque el recurso no se encuentra, normalmente devuelve un 404 que no es error y debemos procesarlo a mano:
...
- Ver ejemplos de uso con method POST por ejemplo:
